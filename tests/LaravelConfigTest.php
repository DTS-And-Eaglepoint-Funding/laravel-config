...
class LaravelConfigTest extends TestCase
{
    ...
    {
        $config = factory(ConfigModel::class)->create(['val' => '0']);
    ...
    {
        $config = factory(ConfigModel::class)->create(['val' => '1']);
    ...
    {
        factory(ConfigModel::class, 3)
            ->create();

        $config = factory(ConfigModel::class, 5)->create([
            'tags' => ['system'],
        ]);
    ...
    public function it_returns_if_a_config_parameter_is_exist(): void
    {
        ...
        factory(ConfigModel::class)->create(['name' => $name]);
        $response = $this->laravelConfig->has($name);
    ...
    {
        factory(ConfigModel::class)->times(2)->create();
    ...
    {
        factory(ConfigModel::class)->create([
            'name' => 'foo.bar',
            'val' => true,
        ]);
